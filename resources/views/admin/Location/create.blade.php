        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('location.index') }}" class="btn btn-primary">Go Back to Create List</a>
                </div>
                </div>
                ...
                <form action="{{route('location.store')}}" method="POST">
                  ...
                  <input type="address" name="address" class="form-control" id="address" placeholder="Password" fdprocessedid="qbjbhf">
                  </div>
                  </div>
